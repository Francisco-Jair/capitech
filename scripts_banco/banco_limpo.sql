...
-- Copiando dados para a tabela capacitacoes.mdl_backup_controllers: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='This table stores block instances. The type of block this is';

-- Copiando dados para a tabela capacitacoes.mdl_block_instances: ~20 rows (aproximadamente)
...
INSERT INTO `mdl_block_instances` (`id`, `blockname`, `parentcontextid`, `showinsubcontexts`, `pagetypepattern`, `subpagepattern`, `defaultregion`, `defaultweight`, `configdata`) VALUES
	...
	(14, 'private_files', 6, 0, 'my-index', '3', 'side-post', 0, ''),
	(15, 'online_users', 6, 0, 'my-index', '3', 'side-post', 1, ''),
	(16, 'badges', 6, 0, 'my-index', '3', 'side-post', 2, ''),
	(17, 'calendar_month', 6, 0, 'my-index', '3', 'side-post', 3, ''),
	(18, 'calendar_upcoming', 6, 0, 'my-index', '3', 'side-post', 4, ''),
	(19, 'lp', 6, 0, 'my-index', '3', 'content', 0, ''),
	(20, 'course_overview', 6, 0, 'my-index', '3', 'content', 1, '');
...
-- Copiando dados para a tabela capacitacoes.mdl_block_positions: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_block_recent_activity: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_cache_flags: ~1 rows (aproximadamente)
...
INSERT INTO `mdl_cache_flags` (`id`, `flagtype`, `name`, `timemodified`, `value`, `expiry`) VALUES
	(1, 'userpreferenceschanged', '2', 1475505521, '1', 1475512721);
...
-- Copiando dados para a tabela capacitacoes.mdl_chat: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=1013 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Changes done in server configuration through admin UI';

-- Copiando dados para a tabela capacitacoes.mdl_config_log: ~985 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_config_plugins: ~1.158 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_context: ~25 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_course: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_course_categories: ~1 rows (aproximadamente)
...
INSERT INTO `mdl_course_categories` (`id`, `name`, `idnumber`, `description`, `descriptionformat`, `parent`, `sortorder`, `coursecount`, `visible`, `visibleold`, `timemodified`, `depth`, `path`, `theme`) VALUES
	(1, 'Miscelânea', NULL, NULL, 0, 0, 10000, 0, 1, 1, 1475503294, 1, '/1', NULL);
...
-- Copiando dados para a tabela capacitacoes.mdl_course_format_options: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_course_modules: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_course_sections: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_editor_atto_autosave: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_enrol: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_event: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_external_functions: ~376 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_files: ~7 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_forum: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_grade_categories: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_grade_categories_history: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_grade_items: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_grade_items_history: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_logstore_standard_log: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_role_assignments: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_role_capabilities: ~1.149 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_sessions: ~1 rows (aproximadamente)
...
INSERT INTO `mdl_sessions` (`id`, `state`, `sid`, `userid`, `sessdata`, `timecreated`, `timemodified`, `firstip`, `lastip`) VALUES
	(2, 0, 'f1geos9u5j9sustjat64nn7ou4', 2, NULL, 1475503733, 1475506389, '127.0.0.1', '127.0.0.1');
...
-- Copiando dados para a tabela capacitacoes.mdl_tool_recyclebin_course: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_upgrade_log: ~1.203 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_user: ~2 rows (aproximadamente)
...
INSERT INTO `mdl_user` (`id`, `auth`, `confirmed`, `policyagreed`, `deleted`, `suspended`, `mnethostid`, `username`, `password`, `idnumber`, `firstname`, `lastname`, `email`, `emailstop`, `icq`, `skype`, `yahoo`, `aim`, `msn`, `phone1`, `phone2`, `institution`, `department`, `address`, `city`, `country`, `lang`, `calendartype`, `theme`, `timezone`, `firstaccess`, `lastaccess`, `lastlogin`, `currentlogin`, `lastip`, `secret`, `picture`, `url`, `description`, `descriptionformat`, `mailformat`, `maildigest`, `maildisplay`, `autosubscribe`, `trackforums`, `timecreated`, `timemodified`, `trustbitmask`, `imagealt`, `lastnamephonetic`, `firstnamephonetic`, `middlename`, `alternatename`) VALUES
	...
	(2, 'manual', 1, 0, 0, 0, 1, 'infatec', '$2y$10$wFS8vrl6WVYlaNYtRl7ngOABzrWq2YkSFdxXz3gCWH5h6SGor9z9S', '', 'INFATEC', 'SOLUÇÕES TECNOLÓGICAS', 'rupertlustosa@gmail.com', 0, '', '', '', '', '', '(86) 3221-7371', '', '', '', '', 'Teresina', 'BR', 'pt_br', 'gregorian', '', '99', 1475503733, 1475506353, 0, 1475503733, '127.0.0.1', '', 0, '', 'Esse é o usuário padrão da Infatec', 1, 1, 0, 1, 1, 0, 0, 1475505520, 0, NULL, '', '', '', '');
...
-- Copiando dados para a tabela capacitacoes.mdl_user_enrolments: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_user_lastaccess: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela capacitacoes.mdl_user_preferences: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `mdl_user_preferences` DISABLE KEYS */;
INSERT INTO `mdl_user_preferences` (`id`, `userid`, `name`, `value`) VALUES
	(1, 2, 'auth_manual_passwordupdatetime', '1475505520'),
...
-- Copiando dados para a tabela capacitacoes.mdl_workshop: ~0 rows (aproximadamente)
