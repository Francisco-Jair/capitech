...
class RelatorioAnaliticoAlunoSemCPF implements IRelatorio
{
    private $pdf;
    ...
    public function processaRelatorio($filtro)
    {
        ...
        if (is_array($filtro)) {
            ...
            $this->pdf->setTituloDoRelatorio('Relação de alunos sem CPF');
...
//                    $pdfTable->addHeader($headerPdfTable3);
                    ...
                    $alunos = Matricula::where('username', 'like', '000000%')
