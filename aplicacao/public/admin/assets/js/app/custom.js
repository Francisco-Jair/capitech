...
$(function(){
	...
	********************************/
	if( $.isFunction($.fn.chosen) ){
        ...
        var config = {
            '.chosen-select'           : {},
            '.chosen-select-deselect'  : {allow_single_deselect:true, no_results_text:'Oops, nada encontrado!'},
	...
	********************************/
	if( $.isFunction($.fn.datetimepicker) ){
		...
		$('#datetimerangepicker1').datetimepicker({pickTime: false});
		$('#datetimerangepicker2').datetimepicker({pickTime: false});
