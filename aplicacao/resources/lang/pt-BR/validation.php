...
return array(
    ...
    */
    ...
    "required"         => "É obrigatória a indicação de um valor para esse campo.",
    ...
    "unique"           => "O valor indicado para esse campo já se encontra registrado.",
    "url"              => "O formato do URL indicado para esse campo é inválido.",
