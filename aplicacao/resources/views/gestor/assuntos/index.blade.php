...
@section('main')
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="{{ URL::route('gestor.assuntos.create') }}"
                   id="link-create"
                   data-toggle="tooltip" data-placement="top"
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="well" style="display: none">
                <div class="row">
                    ...
                    {{--<div class="form-group">
                        ...
                        {!! Form::text('assunto', ( \Request::query('assunto') ? \Request::query('assunto') : null),
                            [
                                'class'=>'form-control',
                                'id' => 'assunto',
                                'placeholder'=>'',
                    ...
                    {{--<div class="form-group">
                        <label for="emails" class="col-sm-2 control-label">E-mails </label>

                        {!! Form::text('emails', ( \Request::query('emails') ? \Request::query('emails') : null),
                            [
                                'class'=>'form-control',
                                'id' => 'emails',
                                'placeholder'=>'',
            ...
            @if ($dados->count())
                <form name="frm_search_assuntos"
                      id="frm_search_assuntos"
                      method="get"
                      action="{{ URL::route('gestor.assuntos.index') }}"
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach ($dados as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{ URL::route('gestor.assuntos.show', [$item->id]) }}?read=true"
