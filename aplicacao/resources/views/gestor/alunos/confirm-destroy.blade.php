    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            @if  ( count($verificacao) == 0 )
                {!! Form::open( [
                    'route' => ['gestor.alunos.destroy', $item->id],
                    'method' => 'delete',
                    'id' => 'form-destroy',
                ...
                <h4>
                    <strong>Deseja realmente remover o Aluno '{{ $item->firstname  }}'?</strong>
                    <br/>
                    <small>As matrículas e frequêcias também serão removidas.</small>
                </h4>
                <br/>
