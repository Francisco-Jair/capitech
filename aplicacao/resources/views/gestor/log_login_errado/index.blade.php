...
@section('main')
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                {{--<a href="{{ URL::route('gestor.log_login_errado.create') }}"
                   id="link-create"
                   data-toggle="tooltip" data-placement="top"
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <form name="frm_search_log_login_errado"
                  id="frm_search_log_login_errado"
                  method="get"
                  action="{{ URL::route('gestor.log_login_errado.index') }}"
                  role="form">
                    ...
                    @foreach ($dados as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ URL::route('gestor.log_login_errado.show', [$item->id]) }}?read=true"
