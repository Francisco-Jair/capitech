...
@section('main')
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="{{ URL::route('gestor.configuracoes.create') }}"
                   id="link-create"
                   data-toggle="tooltip" data-placement="top"
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            @if ($dados->count())
                <form name="frm_search_configuracoes"
                      id="frm_search_configuracoes"
                      method="get"
                      action="{{ URL::route('gestor.configuracoes.index') }}"
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach ($dados as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{ URL::route('gestor.configuracoes.show', [$item->id]) }}?read=true"
