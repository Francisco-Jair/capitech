    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            @if  ( count($verificacao) == 0 )
                {!! Form::open( [
                    'route' => ['gestor.aulas.destroy', $item->id],
                    'method' => 'delete',
                    'id' => 'form-destroy',
                ...
                <h4>
                    <strong>Deseja realmente remover a aula #{{ $item->id  }}?</strong>
                </h4>
                <br/>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Data da Aula: </label>

                    <div class="col-sm-7">
                        <p class="form-control-static">{!! $item->data_aula !!}</p>
                    </div>
                </div>
                <br/>
