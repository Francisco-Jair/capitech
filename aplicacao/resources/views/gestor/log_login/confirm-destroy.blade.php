    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            @if  ( count($verificacao) == 0 )
                {!! Form::open( [
                    'route' => ['gestor.log_login.destroy', $item->id],
                    'method' => 'delete',
                    'id' => 'form-destroy',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <p class="form-control-static">Gestor: {!! $item->gestor->nome !!}</p>

                        <p class="form-control-static">Data de entrada: {!! $item->data_entrada !!}</p>

                        <p class="form-control-static">Data de saída: {!! $item->data_saida !!}</p>

                        <p class="form-control-static">IP: {!! $item->ip !!}</p>
                    </div>
                </div>
                <br/>
