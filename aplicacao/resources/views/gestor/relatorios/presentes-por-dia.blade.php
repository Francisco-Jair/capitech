...
@section('main')
    ...
    <div class="page-header">
        <div class="container-fluid">
            <h3>Relatório de presentes por dia</h3>
        </div>
    </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(
            [
                'route' => ['gestor.relatorios.alunos_presentes_por_dia'],
                'method' => 'get',
                'id' => 'form-update',
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Tipo de presenças <span class="obrigatorio">*</span></label>

                <div class="col-sm-7">
                    <input type="radio" name="tipo_presenca" value="presenca_completa"checked> 100% presença </br>
                    <input type="radio" name="tipo_presenca" value="alguma_presenca" > Alguma presença
