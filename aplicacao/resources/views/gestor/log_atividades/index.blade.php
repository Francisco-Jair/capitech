...
@section('main')
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                {{--<a href="{{ URL::route('gestor.log_atividades.create') }}"
                   id="link-create"
                   data-toggle="tooltip" data-placement="top"
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <form name="frm_search_log_atividades"
                  id="frm_search_log_atividades"
                  method="get"
                  action="{{ URL::route('gestor.log_atividades.index') }}"
                  role="form">
                    ...
                    @foreach ($dados as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ URL::route('gestor.log_atividades.show', [$item->id]) }}?read=true"
