    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            @if  ( count($verificacao) == 0 )
                {!! Form::open( [
                    'route' => ['gestor.log_atividades.destroy', $item->id],
                    'method' => 'delete',
                    'id' => 'form-destroy',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <p class="form-control-static">Operação: {!! $item->operacao !!}</p>

                        <p class="form-control-static">Módulo: {!! $item->modulo !!}</p>

                        <p class="form-control-static">Página: {!! $item->pagina !!}</p>
                    </div>
                </div>
                <br/>
