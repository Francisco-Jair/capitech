        ...
        <div class="container-fluid">
            <div class="pull-right">
                ...
                @elseif(isset($item->id))
                    <a href="{{ URL::route('gestor.contato_configuracoes.edit', [$item->id]) }}?read=true"
                       id="link-cancel-edit"
                       data-toggle="tooltip" data-placement="top"
                ...
                <a href="{{ URL::route('gestor.contato_configuracoes.index') }}"
                   id="link-index"
                   data-toggle="tooltip" data-placement="top"
                   title="Listar tudo"
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            @if  ( count($verificacao) == 0 )
                {!! Form::open( [
                    'route' => ['gestor.contato_configuracoes.destroy', $item->id],
                    'method' => 'delete',
                    'id' => 'form-destroy',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <p class="form-control-static">{!! $item->chave !!}</p>
                    </div>
                </div>
                <br/>
